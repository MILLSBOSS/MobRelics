...
/**
 * Factory and validator for the "RelicLaw Tome" item traded by librarians.
 * When used, it applies the RelicLaw tag to a valid pickaxe.
 */
public final class RelicLawTome {

    private static final String TOME_TAG = "reliclaw_tome";

    private RelicLawTome() {}
    ...
    public static ItemStack create(NamespacedKey pluginKey) {
        ...
        if (meta != null) {
            ...
            lore.add(ChatColor.LIGHT_PURPLE + "Relics Law I");
            meta.setLore(lore);
            meta.addItemFlags(ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_ATTRIBUTES);

            PersistentDataContainer pdc = meta.getPersistentDataContainer();
            // Mark the item as a RelicLaw Tome
